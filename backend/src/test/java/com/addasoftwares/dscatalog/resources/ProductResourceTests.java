...
@WebMvcTest(value = ProductResource.class, excludeAutoConfiguration = {SecurityAutoConfiguration.class}) //Incluída a exclusão dos testes de segurança.
public class ProductResourceTests {
	...
	@Test
	public void deleteShouldReturnNoFoundtWhenIdDoesNotExist() throws Exception {
	...
	@Test
	public void updateIdShouldReturnProductWhenIdDoesNotExist() throws Exception {
